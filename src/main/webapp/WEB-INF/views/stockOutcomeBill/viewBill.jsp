        ...
        <div class="ui_content">
            <table cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
                <tr>
                    ...
                    <td class="ui_text_lt">
                        <input  class="ui_input_txt02" value="${stockOutcomeBill.sn}"/>
                    </td>
                </tr>
                <tr>
                    <td class="ui_text_rt" width="140">仓库</td>
                    <td class="ui_text_lt">
                        <input  class="ui_input_txt02" value="${stockOutcomeBill.depot.name}"/>
                    </td>
                </tr>
                <tr>
                    <td class="ui_text_rt" width="140">客户</td>
                    <td class="ui_text_lt">
                        <input  class="ui_input_txt02" value="${stockOutcomeBill.client.name}"/>
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="ui_text_lt">
                        ...
                        <input name="vdate" class="ui_input_txt02 Wdate" value="${vdate}" />
                    </td>
                </tr>
                <tr>
