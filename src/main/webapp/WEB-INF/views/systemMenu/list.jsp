...
<head>
    ...
    <title>叩丁狼教育PSS（演示版）-系统菜单管理</title>
    <style>
        .alt td {
        ...
        <div class="ui_content">
            <div class="ui_text_indent">
                <div id="box_border">
                    ...
                    <div id="box_bottom">
                        <input type="button" value="新增" class="ui_input_btn01 btn_input" data-url="/systemMenu/input.do?parentId=${qo.parentId}"/>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="ui_content">
            <div class="ui_tb">
                <table class="table" cellspacing="0" cellpadding="0" width="100%" align="center" border="0">
                    ...
                    <tbody>
                    <c:forEach items="${result.listData}" var="systemMenu">
                        <tr>
                            ...
                            <td>
                                <a href="/systemMenu/input.do?id=${systemMenu.id}&parentId=${qo.parentId}">编辑</a>
                                <a href="javascript:;" class="btn_delete" data-url="/systemMenu/delete.do?id=${systemMenu.id}">删除</a>
