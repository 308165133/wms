...
<body>
<form name="editForm" data-url="/employee/list.do" action="/employee/saveOrUpdate.do" method="post" id="editForm">
        ...
        <div class="ui_content">
            <table cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
                ...
                <tr>
                    ...
                    <td class="ui_text_lt">
                        <select class="ui_select01" name="department.id">
                ...
                <tr>
                    ...
                    <td class="ui_text_lt">
                        <input type="checkbox" name="admin" ${employee.admin?"checked='checked'":""}  class="ui_checkbox01"></input>
                    </td>
                </tr>
                <tr>
