                    ...
                    <div id="box_center">
                        ...
                        <select class="ui_select01" name="deptId">
                            ...
                            <c:forEach items="${departments}" var="department">
                                <option value="${department.id}" ${qo.deptId==department.id?"selected='selected'":""}>${department.name}</option>
                            </c:forEach>
                        </select>
                    </div>
                    <div id="box_bottom">
        ...
        <div class="ui_content">
            <div class="ui_tb">
                <table class="table" cellspacing="0" cellpadding="0" width="100%" align="center" border="0">
                    ...
                    <tbody>
                    <c:forEach items="${result.listData}" var="employee">
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="javascript:;" class="btn_delete" data-url="/employee/delete.do?id=${employee.id}">删除</a>
                        </td>
                    </tr>
                    </c:forEach>
                    </tbody>
