        ...
        <div class="ui_content">
            <div class="ui_text_indent">
                <div id="box_border">
                    ...
                    <div id="box_bottom">
                        <input type="button" value="新增" class="ui_input_btn01 btn_input" data-url="/depot/input.do"/>
                    </div>
                </div>
            </div>
        </div>
        <div class="ui_content">
            <div class="ui_tb">
                <table class="table" cellspacing="0" cellpadding="0" width="100%" align="center" border="0">
                    ...
                    <tbody>
                    <c:forEach items="${result.listData}" var="depot">
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="javascript:;" class="btn_delete" data-url="/depot/delete.do?id=${depot.id}">删除</a>
                            </td>
                        </tr>
                    </c:forEach>
                    </tbody>
