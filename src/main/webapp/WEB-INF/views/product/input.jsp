...
<body>
<form name="editForm" data-url="/product/list.do" action="/product/saveOrUpdate.do" method="post" enctype="multipart/form-data" id="editForm">
        ...
        <div class="ui_content">
            <table cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
                    ...
                    <td class="ui_text_lt">
                        <select class="ui_select01" name="brandId">
                            <c:forEach items="${brands}" var="brand">
                                <option value="${brand.id}" ${product.brandId==brand.id?"selected='selected'":""}>${brand.name}</option>
                            </c:forEach>
                        </select>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="ui_text_lt">
                        <textarea name="intro"  rows="10" cols="50">${product.intro}</textarea>
                    </td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
